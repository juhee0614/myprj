...
//원글 생성
	...
	public Long modifyItem(Long bnum, BoardDTO boardDTO) {
		...
		int rows =  jt.update(sql.toString(),boardDTO.getBcategory(),
																				boardDTO.getBtitle(),
	...
	public List<BoardDTO> list() {
			...
			List<BoardDTO> list =  jt.query(sql.toString(),
...
StringBuffer sql = new StringBuffer();
	...
	public long titalRecordCount() {
		...
		long cnt = jt.queryForObject(sql.toString(), Long.class);
		return cnt;
	}
	//게시판 카테고리별 레코드수 
	@Override
...
StringBuffer sql = new StringBuffer();
		...
		long cnt = jt.queryForObject(sql.toString(), Long.class,bcategory);
		return cnt;
	}
}
